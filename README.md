...
MNIST/
  src/
    ...
    model.py           # Both SimpleNN & CNN architecture present 
    train.py           # Training on CNN + evaluation + metrics + graphs
  data/                # Downloaded MNIST dataset
  models/
    mnist_model.pth    # Trained model weights by SimpleNN
    mnist_cnn.pth      # Trained model weights by CNN(default)
  results/
